<template>
  <div class="fixed top-48 lg:top-80 left-0 overflow-y-auto font-bold px-16 md:px-30 md:pt-24 pt-16 pb-8 md:pb-64 h-87 w-full shadow-100 bg-white z-40">
    <div class="max-w-1120 mx-auto text-terciary">
      <app-button
        ...
        <span class="icon-arrow-bold rotate-180 text-mobile-note leading-default mr-8" />
        <span class="leading-default">Back</span>
      </app-button>

      <!-- Find your city -->
      <div class="pt-16 md:pt-48 pb-35 md:pb-0 flex justify-between flex-col lg:flex-row items-start">
        <h2 class="text-terciary text-mobile-h2 md:text-desktop-h1 font-bold text-left lg:max-w-264 w-full mr-0 lg:mr-105 mb-16 lg:mb-0">
          Find your city
        </h2>
        <div class="discover-cities__card-wrap max-w-800 w-full">
          <!-- <div
            ...
            :key="index">
             <nuxt-link :to="`/${ city.slug }`" @click.native="$emit('update:isSearchPopupOpen', false)">
